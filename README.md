...
├── contact.html            # Dedicated Booking & Contact Page
├── css/
│   ├── main.css            # Core Layout, Typography & Reset
│   └── components.css      # Luxury Components, Modals & Animations
├── js/
│   ├── app.js              # Testimonials, City Directory, Modal Logic
│   └── mockData.js         # Client Reviews & City Database
└── images/                 # Optimized Performance & Portrait Assets
`
