...
import { TESTIMONIALS_DATA, VIDEO_TESTIMONIALS_DATA } from './data/testimonials.js?v=20260921_v28';
import { GENERAL_FAQS } from './data/faqs.js?v=20260911_v19';
import { renderCityPage } from './components/cityRenderer.js?v=20260821_v3';
import { setupBookingModal } from './components/bookingModal.js?v=20260921_v46';
...
function setupHeroForm() {
  ...
  if (heroForm) {
    heroForm.addEventListener("submit", (e) => {
      ...
      if (btn) {
        btn.disabled = true;
        btn.innerHTML = "<span>⚡ Submitting to adrian@saintmentalist.com...</span>";
      }
      ...
      .catch(err => {
        console.error("Hero form submission error, falling back to direct submit:", err);
        heroForm.submit();
      });
